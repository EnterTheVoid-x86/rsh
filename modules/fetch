#!/bin/sh
#
# fetch - v1.00 - based on pfetch, edited for rsh.
...
get_shell() {
    # Display the rsh shell name.
    log shell "rsh 1.40" >&6
}
...
EOF
    ...
    # shellcheck disable=2086
    {
        ...
        # contents of 'PF_INFO'.
        set -f
        set +f -- ${PF_INFO-ascii title os host kernel shell uptime pkgs memory}
